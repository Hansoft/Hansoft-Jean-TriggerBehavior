...
{
    class DefaultIntColumnToken : IExpressionItem, IAssignable
    {
        ...
        public DefaultIntColumnToken(EHPMTaskField taskField, EHPMProjectDefaultColumn column, string property)
        {
        ...
        {
            task.GetType().GetProperty(property).SetValue(task, value.ToInt());
        }
    }
}